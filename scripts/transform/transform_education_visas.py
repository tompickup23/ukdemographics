...
XLSX = newest_release(ROOT / "data/raw/ho_visas_extra", "education-visas-datasets")
...
def main():
    ...
    out = {
        "source": (
            ...
            "and grants by course level, "
            f"{period_phrase(XLSX)} release. Sheets Data_Edu_D01 (applications) and "
